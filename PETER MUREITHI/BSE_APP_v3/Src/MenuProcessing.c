...
//TODO (Valentine) Check why static void is being picked as a non variable

void ShortCutMenu_Management_Reports(void){
	int ret = 0;
...
int MenuProcessingSelect(word MnuItm) {
	...
	case mnuSale:
		MAPPUTSTR(traRqsBitMap, "087014078020C09A00",lblKO);
		//MAPPUTSTR(traRqsBitMap, "087024058000C11204",lblKO);087014078020C09A00
